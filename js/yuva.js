...
const quizData = [
  {
    ...
    options: ['Cry', 'Sad', 'Happy', 'Proud'],
    correctOptions: [2] // Indexes of the correct options (0-3)
  },
{
    questionImage: 'images/cry.jpg',
    options: ['Surprised', 'Irritated', 'Cry', 'Silly'],
    correctOptions: [2] // Indexes of the correct options (0-3)
  },
{
    questionImage: 'images1/scared.jpg',
    options: ['Scared', 'Happy', 'Sad', 'Proud'],
    correctOptions: [0] // Indexes of the correct options (0-3)
  },
{
    questionImage: 'images/angry.jpg',
    options: ['Scared', 'Angry', 'Cry', 'Sad'],
    correctOptions: [1] // Indexes of the correct options (0-3)
  },
{
    questionImage: 'images1/surprised.jpg',
    options: ['Cry', 'silly', 'Surprised', 'Bored'],
    correctOptions: [2] // Indexes of the correct options (0-3)
  },
{
    questionImage: 'images1/shy.jpg',
    options: ['Surprised', 'Scared', 'Cry', 'Shy'],
    correctOptions: [3] // Indexes of the correct options (0-3)
  },
{
    questionImage: 'images1/sad.jpg',
    options: ['Cry', 'Sad', 'Silly', 'Proud'],
    correctOptions: [1] // Indexes of the correct options (0-3)
  },
{
    questionImage: 'images/bored.jpg',
    options: ['Surprised', 'Anger', 'bored', 'Scared'],
    correctOptions: [2] // Indexes of the correct options (0-3)
  },
{
    questionImage: 'images1/silly.jpg',
    options: ['Silly', 'Sad', 'Happy', 'Proud'],
    correctOptions: [0] // Indexes of the correct options (0-3)
  },
{
    questionImage: 'images1/sick.jpg',
    options: ['Sick', 'Anger', 'Cry', 'Scared'],
    correctOptions: [0] // Indexes of the correct options (0-3)
  },
